 ...
 * @author yaroslav
 */
public class PnlVacTurnOff extends javax.swing.JPanel {

    private HVV_Constructor theApp;
    private DefaultComboBoxModel cmbObjectModel;
    
    /**
     * Creates new form PnlVacTurnOff
     */
    public PnlVacTurnOff( HVV_Constructor app) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Выключаемый объект:");
        add(jLabel1);
